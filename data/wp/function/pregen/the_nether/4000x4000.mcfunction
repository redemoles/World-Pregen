...
#> wp:pregen/the_nether/4000x4000
#
# @within			
#
#
# @description		Génération de la map en 4000x4000, toute dimension confondue
#
...
scoreboard players set #the_nether_working wp.pregen 4
