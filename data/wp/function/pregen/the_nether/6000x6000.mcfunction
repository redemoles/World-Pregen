...
#> wp:pregen/the_nether/6000x6000
#
# @within			
#
#
# @description		Génération de la map en 6000x6000, toute dimension confondue
#
...
scoreboard players set #the_nether_working wp.pregen 6
