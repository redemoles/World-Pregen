...
#> wp:pregen/the_nether/20000x20000
#
# @within			
#
#
# @description		Génération de la map en 20000x20000, toute dimension confondue
#
...
scoreboard players set #the_nether_working wp.pregen 20
