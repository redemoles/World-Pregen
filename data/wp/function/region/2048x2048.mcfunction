...
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1004 run tellraw @a [$(text),{"text":"2048x2048 (0/48, 0%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1006 run tellraw @a [$(text),{"text":"2048x2048 (1/48, 2%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1009 run tellraw @a [$(text),{"text":"2048x2048 (2/48, 4%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1011 run tellraw @a [$(text),{"text":"2048x2048 (3/48, 6%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1014 run tellraw @a [$(text),{"text":"2048x2048 (4/48, 8%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1016 run tellraw @a [$(text),{"text":"2048x2048 (5/48, 10%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1019 run tellraw @a [$(text),{"text":"2048x2048 (6/48, 12%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1021 run tellraw @a [$(text),{"text":"2048x2048 (7/48, 14%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1024 run tellraw @a [$(text),{"text":"2048x2048 (8/48, 16%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1026 run tellraw @a [$(text),{"text":"2048x2048 (9/48, 18%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1029 run tellraw @a [$(text),{"text":"2048x2048 (10/48, 20%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1031 run tellraw @a [$(text),{"text":"2048x2048 (11/48, 22%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1034 run tellraw @a [$(text),{"text":"2048x2048 (12/48, 25%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1036 run tellraw @a [$(text),{"text":"2048x2048 (13/48, 27%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1039 run tellraw @a [$(text),{"text":"2048x2048 (14/48, 29%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1041 run tellraw @a [$(text),{"text":"2048x2048 (15/48, 31%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1044 run tellraw @a [$(text),{"text":"2048x2048 (16/48, 33%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1046 run tellraw @a [$(text),{"text":"2048x2048 (17/48, 35%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1049 run tellraw @a [$(text),{"text":"2048x2048 (18/48, 37%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1051 run tellraw @a [$(text),{"text":"2048x2048 (19/48, 39%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1054 run tellraw @a [$(text),{"text":"2048x2048 (20/48, 41%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1056 run tellraw @a [$(text),{"text":"2048x2048 (21/48, 43%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1059 run tellraw @a [$(text),{"text":"2048x2048 (22/48, 45%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1061 run tellraw @a [$(text),{"text":"2048x2048 (23/48, 47%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1064 run tellraw @a [$(text),{"text":"2048x2048 (24/48, 50%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1067 run tellraw @a [$(text),{"text":"2048x2048 (25/48, 52%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1069 run tellraw @a [$(text),{"text":"2048x2048 (26/48, 54%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1072 run tellraw @a [$(text),{"text":"2048x2048 (27/48, 56%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1074 run tellraw @a [$(text),{"text":"2048x2048 (28/48, 58%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1077 run tellraw @a [$(text),{"text":"2048x2048 (29/48, 60%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1079 run tellraw @a [$(text),{"text":"2048x2048 (30/48, 62%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1082 run tellraw @a [$(text),{"text":"2048x2048 (31/48, 64%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1084 run tellraw @a [$(text),{"text":"2048x2048 (32/48, 66%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1087 run tellraw @a [$(text),{"text":"2048x2048 (33/48, 68%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1089 run tellraw @a [$(text),{"text":"2048x2048 (34/48, 70%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1092 run tellraw @a [$(text),{"text":"2048x2048 (35/48, 72%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1094 run tellraw @a [$(text),{"text":"2048x2048 (36/48, 75%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1097 run tellraw @a [$(text),{"text":"2048x2048 (37/48, 77%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1099 run tellraw @a [$(text),{"text":"2048x2048 (38/48, 79%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1102 run tellraw @a [$(text),{"text":"2048x2048 (39/48, 81%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1104 run tellraw @a [$(text),{"text":"2048x2048 (40/48, 83%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1107 run tellraw @a [$(text),{"text":"2048x2048 (41/48, 85%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1109 run tellraw @a [$(text),{"text":"2048x2048 (42/48, 87%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1112 run tellraw @a [$(text),{"text":"2048x2048 (43/48, 89%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1114 run tellraw @a [$(text),{"text":"2048x2048 (44/48, 91%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1117 run tellraw @a [$(text),{"text":"2048x2048 (45/48, 93%)","color":"#FFFFFF"}]
$execute if score #$(dimension)_chunk_pregen_$(area) wp.pregen matches 1119 run tellraw @a [$(text),{"text":"2048x2048 (46/48, 95%)","color":"#FFFFFF"}]
